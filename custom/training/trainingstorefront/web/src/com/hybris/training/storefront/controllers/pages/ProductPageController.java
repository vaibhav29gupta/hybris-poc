...
public class ProductPageController extends AbstractPageController
{
			...
			final List<ProductOption> extraOptions) throws CMSItemNotFoundException
	{
		...
		final ProductData productData1 = samsungProductFacade.getColorCode();
		//		final ProductData productData1 = getSamsungInfoConverter().convert(samsung);
		model.addAttribute(productData1);
